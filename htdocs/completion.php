...
if($NTableGet == ""){
$DSTableGet = "<a href='completion.php?TableGet=1'>Delivery</a>";
$PUTableGet = "<a href='completion.php?TableGet=2'>Pick-up</a>";
$NCITableGet = "<a href='completion.php?TableGet=3'>New Cust. Info</a>";
// $InvTableGet = "<a href='completion.php?TableGet=4'>Invoice</a>";
}
if($NTableGet == 1){
...
// $InvTableGet = "<a href='completion.php?TableGet=4'>Invoice</a>";
}/* HIDE INVOICE FROM completion FORM
if($NTableGet == 4){
$TableGet = "Invoice";
$OIGet = 1;
$ATableGet = "invoice";
...
?>
    ...
    <html>
    <head>
        <title>Brevard Medical Equipment :: Completion</title>
    </head>
    <body>
    <div align=center>
<?php
...
?> Completion:</br> <?php echo $DSTableGet; ?> | <?php echo $PUTableGet; ?> | <?php echo $NCITableGet; ?></br><hr>
    </div>
<?php
$Query = "SELECT * FROM " . $TableGet . " WHERE `Verified`='1' AND `Complete`='0' ORDER BY ID DESC"; // Sort each entry by DATE, DESCENDING!
...
?>
                   <table border="2" style="width:100%">
							<tr>
                                <td> | <font color=red><b><?php echo $evitas . " " . $eBHOSP; ?></b></font> | 
                                    <?php
