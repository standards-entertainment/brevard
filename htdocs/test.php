...
<title>TEST TEST TEST</title>
  ...
  #sortable li { margin: 0 3px 3px 3px; padding: 0.4em; padding-left: 1.5em; font-size: 1.4em; height: 200px; }
...
<?PHP
	...
	*/
	...
	/* Get data. */
	$sql = "SELECT * FROM " . $tbl_name . " ORDER BY Order1, ID ASC LIMIT " . $start . ", " . $limit . "";
...
<li class="ui-state-default"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                   <table border="2" style="width:100%">
							<tr>
                                <td> <?php
                                if($NTableGet != 5){
                                		echo "| <font color=red><b>" . $evitas  . $eBHOSP . " | " . $ORDER1 . "</b></font> | "; 
                                	} else {
