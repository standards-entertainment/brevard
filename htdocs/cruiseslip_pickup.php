...
<TR>
<TD COLSPAN=3><font size=2>
SPECIAL INSTRUCTION: <INPUT TYPE=TEXT NAME='SPECIALINSTRUCTIONS' SIZE=85></font>
</TD>
</TR>
<TR>
<TD COLSPAN=3><CENTER>
...
$( "form" ).submit(function( event ) {
  ...
  $( "#flag" ).text( "Driver field MUST be filled!" ).show().fadeOut( 1000 );
  event.preventDefault();
