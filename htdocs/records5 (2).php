...
if($NTableGet == ""){
$DSTableGet = "<a href='records.php?TableGet=1'>Delivery</a>";
$PUTableGet = "<a href='records.php?TableGet=2'>Pick-up</a>";
$NCITableGet = "<a href='records.php?TableGet=3'>New Cust. Info</a>";
$InvTableGet = "<a href='records.php?TableGet=4'>Invoice</a>";
$CruTableGet = "<a href='records.php?TableGet=5'>Cruise</a>";
}
if($NTableGet == 1){
