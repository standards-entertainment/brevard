...
if($NTableGet == ""){
$DSTableGet = "<a href='bhospreport.php?TableGet=1'>Delivery</a>";
$PUTableGet = "<a href='bhospreport.php?TableGet=2'>Pick-up</a>";
$NCITableGet = "<a href='bhospreport.php?TableGet=3'>New Cust. Info</a>";
$InvTableGet = "<a href='bhospreport.php?TableGet=4'>Invoice</a>";
}
if($NTableGet == 1){
...
echo $reportsecho; ?><br> BHOSP Report:</br> <?php echo $DSTableGet; ?> | <?php echo $PUTableGet; ?> | <?php echo $NCITableGet; ?></br><hr>
    </div>
<?php

$Query = "SELECT * FROM " . $TableGet . " WHERE Accomplished='1' AND bhosp='1' ORDER BY ID DESC"; // Sort each entry by DATE, DESCENDING!
...
?>
                   <table border="2" style="width:100%">
							<tr>
                                <td> | <font color=red><b><?php echo $eBHOSP; ?></b></font> | Referral: <?php echo $referral; ?>
                                    <?php
...
if ($TableGet != "Invoice"){ //if its not the invoice then display data from invoice without any mods.
