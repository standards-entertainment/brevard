...
?>
    ...
    <div align=center> 
<?php
$Query = "SELECT * FROM DeliverySlip WHERE `ID`='$get_db_id' ORDER BY ID DESC"; // Sort each entry by DATE, DESCENDING!
...
<?php
	...
	while($information = mysqli_fetch_array($Result))
	{
					...
					$edateofdelivery = $information['DateofDelivery'];
    ...
    <tr>
    <td>
    Patient #: <input name="patientnum" type=text value="<?php echo $epatientnum; ?>"></br>
    ...
    Prepared By: <input name="preparedby" type=text value="<?php echo $epreparedby; ?>">
    Date: <b><u><?php echo $edate1; ?> </u></b>
    Time: <b><u><?php echo $etime; ?></u></b>
    Edit: <b><u><?php echo $eedittime; ?></u></b></br>
    Date of Delivery: <input name="dateofdelivery" type=text size=53 value="<?php echo $edateofdelivery ?>"></br>
    Customer Name: <input name="custname" type=text size=85 value="<?php echo $ecustname; ?>">
    Height: <input name="height" type=text value="<?php echo $eheight; ?>">
    Weight: <input name="weight" type=text value="<?php echo $eweight; ?>"></br>
    Address: <input name="address" type=text size=170 value="<?php echo $eaddress; ?>"></br>
    City: <input name="city" type=text size=67 value="<?php echo $ecity; ?>">
    Zip: <input name="zip" type=text size=12 value="<?php echo $ezip; ?>">
    Phone: <input name="phone" type=text size=67 value="<?php echo $ephone; ?>">
    </td>
    </tr>
    </table>
    <?php
   ...
   EQUIPMENT
    ...
    ?>
    <input name="17b" type=text size=5 value="<?php echo $eeq[25]; ?>"> D Tank 415 Liter Refill USP Medical Oxygen</br>
    <?php
    if($eeq[26] == "") {
    echo "<input name='18a' type=checkbox class='css-checkbox' id='cb18' value='Liter Refill USP Medical Oxygen'><label for='cb18' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='18a' type=checkbox class='css-checkbox' id='cb18' value='Liter Refill USP Medical Oxygen' checked><label for='cb18' class='css-label radGroup1'></label>";
    }
    ?>
    <input name="18b" type=text size=5 value="<?php echo $eeq[27]; ?>"><input name="18c" type=text size=5 value="<?php echo $eeq[28]; ?>"> Liter Refill USP Medical Oxygen</br>
    <?php
    if($eeq[29] == "") {
    echo "<input name='19a' type=checkbox class='css-checkbox' id='cb19' value='Bedside Commode'><label for='cb19' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='19a' type=checkbox class='css-checkbox' id='cb19' value='Bedside Commode' checked><label for='cb19' class='css-label radGroup1'></label>";
    }
    ?>
    Bedside Commode</br>
    &nbsp;&nbsp;
    <?php
    if($eeq[30] == "") {
    echo "<input name='20a' type=checkbox class='css-checkbox' id='cb20' value='Standard #'><label for='cb20' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='20a' type=checkbox class='css-checkbox' id='cb20' value='Standard #' checked><label for='cb20' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[32] == "") {
    echo "<input name='21a' type=checkbox class='css-checkbox' id='cb21' value='X Wide #'><label for='cb21' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='21a' type=checkbox class='css-checkbox' id='cb21' value='X Wide #' checked><label for='cb21' class='css-label radGroup1'></label>";
    }
    ?>
    X Wide [# <input type=text name="21b" value="<?php echo $eeq[33]; ?>"> ]</br>
    <?php
    if($eeq[34] == "") {
    echo "<input name='22a' type=checkbox class='css-checkbox' id='cb22' value='Walker'><label for='cb22' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='22a' type=checkbox class='css-checkbox' id='cb22' value='Walker' checked><label for='cb22' class='css-label radGroup1'></label>";
    }
    ?>
    Walker </br>
    &nbsp;&nbsp;
    <?php
    if($eeq[35] == "") {
    echo "<input name='23a' type=checkbox class='css-checkbox' id='cb23' value='w/ 2 Front Wheels #'><label for='cb23' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='23a' type=checkbox class='css-checkbox' id='cb23' value='W/ 2 Front Wheels #' checked><label for='cb23' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[37] == "") {
    echo "<input name='24a' type=checkbox class='css-checkbox' id='cb24' value='w/ 4 Wheels & Seat #'><label for='cb24' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='24a' type=checkbox class='css-checkbox' id='cb24' value='w/ 4 Wheels & Seat #' checked><label for='cb24' class='css-label radGroup1'></label>";
    }
    ?>
    w/ 4 Wheels & Seat [# <input type=text name="24b" value="<?php echo $eeq[38]; ?>"> ]</br>
    <?php
    if($eeq[39] == "") {
    echo "<input name='25a' type=checkbox class='css-checkbox' id='cb25' value='Nebulizer #'><label for='cb25' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='25a' type=checkbox class='css-checkbox' id='cb25' value='Nebulizer #' checked><label for='cb25' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[41] == "") {
    echo "<input name='26a' type=checkbox class='css-checkbox' id='cb26' value='Nebulizer Tubing'><label for='cb26' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='26a' type=checkbox class='css-checkbox' id='cb26' value='Nebulizer Tubing' checked><label for='cb26' class='css-label radGroup1'></label>";
    }
    ?>
    Nebulizer Tubing</br>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <?php
    if($eeq[42] == "") {
    echo "<input name='27a' type=checkbox class='css-checkbox' id='cb27' value='w/ Mouthpiece'><label for='cb27' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='27a' type=checkbox class='css-checkbox' id='cb27' value='w/ Mouthpiece' checked><label for='cb27' class='css-label radGroup1'></label>";
    }
    ?>
    w/ Mouthpiece</br>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <?php
    if($eeq[43] == "") {
    echo "<input name='28a' type=checkbox class='css-checkbox' id='cb28' value='w/ Mask'><label for='cb28' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='28a' type=checkbox class='css-checkbox' id='cb28' value='w/ Mask' checked><label for='cb28' class='css-label radGroup1'></label>";
    }
    ?>
    w/ Mask</br>
    <?php
    if($eeq[44] == "") {
    echo "<input name='29a' type=checkbox class='css-checkbox' id='cb29' value='Suction Pump #'><label for='cb29' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='29a' type=checkbox class='css-checkbox' id='cb29' value='Suction Pump #' checked><label for='cb29' class='css-label radGroup1'></label>";
    }
    ?>
    Suction Pump [#<input name="29b" type=text value="<?php echo $eeq[45]; ?>">]</br>
    <?php
    if($eeq[46] == "") {
    echo "<input name='30a' type=checkbox class='css-checkbox' id='cb30' value='Over-the-bed Table #'><label for='cb30' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='30a' type=checkbox class='css-checkbox' id='cb30' value='Over-the-bed Table#' checked><label for='cb30' class='css-label radGroup1'></label>";
    }
    ?>
    Over-the-bed Table [#<input name="30b" type=text value="<?php echo $eeq[47]; ?>">]</br>
    <?php
    if($eeq[48] == "") {
    echo "<input name='31a' type=checkbox class='css-checkbox' id='cb31' value='Shower Chair'><label for='cb31' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='31a' type=checkbox class='css-checkbox' id='cb31' value='Shower Chair' checked><label for='cb31' class='css-label radGroup1'></label>";
    }
    ?>
    Shower Chair</br>
    &nbsp;&nbsp;
    <?php
    if($eeq[49] == "") {
    echo "<input name='32a' type=checkbox class='css-checkbox' id='cb32' value='w/ Back #'><label for='cb32' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='32a' type=checkbox class='css-checkbox' id='cb32' value='w/ Back #' checked><label for='cb32' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[51] == "") {
    echo "<input name='33a' type=checkbox class='css-checkbox' id='cb33' value='w/o Back'><label for='cb33' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='33a' type=checkbox class='css-checkbox' id='cb33' value='w/o Back' checked><label for='cb33' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[53] == "") {
    echo "<input name='34a' type=checkbox class='css-checkbox' id='cb34' value='Wheelchair'><label for='cb34' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='34a' type=checkbox class='css-checkbox' id='cb34' value='Wheelchair' checked><label for='cb34' class='css-label radGroup1'></label>";
    }
    ?>
    Wheelchair</br>
    &nbsp;&nbsp;
    <?php
    if($eeq[54] == "") {
    echo "<input name='35a' type=checkbox class='css-checkbox' id='cb35' value='16in Standard #'><label for='cb35' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='35a' type=checkbox class='css-checkbox' id='cb35' value='16in Standard #' checked><label for='cb35' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[56] == "") {
    echo "<input name='36a' type=checkbox class='css-checkbox' id='cb36' value='18in Standard #'><label for='cb36' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='36a' type=checkbox class='css-checkbox' id='cb36' value='18in Standard #' checked><label for='cb36' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[58] == "") {
    echo "<input name='37a' type=checkbox class='css-checkbox' id='cb37' value='20in Wide #'><label for='cb37' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='37a' type=checkbox class='css-checkbox' id='cb37' value='20in Wide #' checked><label for='cb37' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[60] == "") {
    echo "<input name='38a' type=checkbox class='css-checkbox' id='cb38' value='22in X Wide #'><label for='cb38' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='38a' type=checkbox class='css-checkbox' id='cb38' value='22in X Wide #' checked><label for='cb38' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[62] == "") {
    echo "<input name='39a' type=checkbox class='css-checkbox' id='cb39' value='24in XX Wide #'><label for='cb39' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='39a' type=checkbox class='css-checkbox' id='cb39' value='2in XX Wide #' checked><label for='cb39' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[64] == "") {
    echo "<input name='40a' type=checkbox class='css-checkbox' id='cb40' value='Reclining #'><label for='cb40' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='40a' type=checkbox class='css-checkbox' id='cb40' value='Reclining #' checked><label for='cb40' class='css-label radGroup1'></label>";
    }
    ?>
    Reclining [#<input name="40b" type=text value="<?php echo $eeq[65]; ?>">]</br>
    <?php
    if($eeq[66] == "") {
    echo "<input name='41a' type=checkbox class='css-checkbox' id='cb41' value='Transport/Travel Chair #'><label for='cb41' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='41a' type=checkbox class='css-checkbox' id='cb41' value='Transport/Travel Chair #' checked><label for='cb41' class='css-label radGroup1'></label>";
    }
    ?>
    Transport/Travel Chair [# <input name="41b" type=text value="<?php echo $eeq[67]; ?>"> ]</br>
    <?php
    if($eeq[68] == "") {
    echo "<input name='42a' type=checkbox class='css-checkbox' id='cb42' value='Reclining Geri-Chair #'><label for='cb42' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='42a' type=checkbox class='css-checkbox' id='cb42' value='Reclining Geri-Chair #' checked><label for='cb42' class='css-label radGroup1'></label>";
    }
    ?>Reclining Geri-Chair [# <input name="42b" type=text value="<?php echo $eeq[69]; ?>"> ]</br>
    <?php
    if($eeq[70] == "") {
    echo "<input name='43a' type=checkbox class='css-checkbox' id='cb43' value='Lift Chair'><label for='cb43' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='43a' type=checkbox class='css-checkbox' id='cb43' value='Lift Chair' checked><label for='cb43' class='css-label radGroup1'></label>";
    }
    ?>
    Lift Chair</br>
    &nbsp;&nbsp;
    <?php
    if($eeq[71] == "") {
    echo "<input name='44a' type=checkbox class='css-checkbox' id='cb44' value='Capri #'><label for='cb44' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='44a' type=checkbox class='css-checkbox' id='cb44' value='Capri #' checked><label for='cb44' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[73] == "") {
    echo "<input name='45a' type=checkbox class='css-checkbox' id='cb45' value='Maxi #'><label for='cb45' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='45a' type=checkbox class='css-checkbox' id='cb45' value='Maxi #' checked><label for='cb45' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <?php
    if($eeq[75] == "") {
    echo "<input name='46a' type=checkbox class='css-checkbox' id='cb46' value='Regal #'><label for='cb46' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='46a' type=checkbox class='css-checkbox' id='cb46' value='Regal #' checked><label for='cb46' class='css-label radGroup1'></label>";
    }
    ?>
    Regal [#<input name="46b" type=text value="<?php echo $eeq[76]; ?>">]</br>
    <?php
    if($eeq[77] == "") {
    echo "<input name='47a' type=checkbox class='css-checkbox' id='cb47' value='Patient Lift #'><label for='cb47' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='47a' type=checkbox class='css-checkbox' id='cb47' value='Patient Lift #' checked><label for='cb47' class='css-label radGroup1'></label>";
    }
    ?>
    Patient Lift [#<input name="47b" type=text value="<?php echo $eeq[78]; ?>">]</br>
    <?php
    if($eeq[79] == "") {
    echo "<input name='48a' type=checkbox class='css-checkbox' id='cb48' value='Other'><label for='cb48' class='css-label radGroup1'></label>";
    } else {
    echo "<input name='48a' type=checkbox class='css-checkbox' id='cb48' value='Other' checked><label for='cb48' class='css-label radGroup1'></label>";
    }
    ?>
    ...
    <tr>
    <td colspan=3>
    Special Instructions: <input type="text" name="specialinstructions" size=185 value="<?php echo $especialinstructions; ?>">
    </td>
    </tr>
    </table>
    ...
    */
    ...
    <tr>
    <td>
    Driver/Office: <input name="driver_office" type=text size=70 id="doffice" value="<?php echo $edoffice; ?>"><font SIZE="2" color=red><b>*REQUIRED</b></font>
    </td>
    </tr> 
    </b>
    </table></br>
    ...
    <tr>
    <td>
    Lot Number USP Oxygen Delivery:</br> <textarea name="LNUSPO2Del" rows=7 cols=50><?php echo $elnuspo2del; ?></textarea>
    </td>
    <td>
    Lot Number Empty Cylinder Pickup:</br> <textarea name="LNECPU" rows=7 cols=50><?php echo $elnecpu; ?></textarea>
    </td>
    </tr>
    <?php
}
...
if(isset($_POST['bhosp'])){
	...
	echo "<script type='text/javascript'>alert('$message');</script>";
				...
				echo "<br><a href='delslip_edit.php?ID=" . $get_db_id . "'>Next Form</a>";
				echo "</div>";
				header('Location: delslip_edit.php?ID=' . $get_db_id);
	}
	}
?>
