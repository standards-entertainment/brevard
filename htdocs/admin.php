...
<?php
	...
	if($u_type == 'a'){
		echo " (" . $u_levelname . ") <a href='option.php?u_id=$u_id&type=$u_type'>Deactivate</a> | <a href='user_edit.php?u_id=$u_id&u_username=$u_username&u_ulevel=$u_ulevel&type=$u_type&u_cell=$u_cell'>Edit</a> | <a href='user_delete.php?u_id=$u_id&u_username=$u_username'>Delete</a>";
	} else {
		echo " (" . $u_levelname . ") <a href='option.php?u_id=$u_id&type=$u_type'>Activate</a> | <a href='user_edit.php?u_id=$u_id&u_username=$u_username&u_ulevel=$u_ulevel&type=$u_type&u_cell=$u_cell'>Edit</a> | <a href='user_delete.php?u_id=$u_id&u_username=$u_username'>Delete</a>";
	}
			}
?>
</div>
...
if(isset($_POST['submit'])){
	...
	$nusername = filter_var($username1, FILTER_SANITIZE_STRING);
