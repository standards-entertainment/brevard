...
?>
    ...
    <html>
    <head>
        <title>Brevard Medical Equipment :: New Customer Information</title>
    <div align=center>
    ...
    <td>
    Prepared By: <input name="preparedby" type=text></br>
    </td>
    <td>
    ...
    <tr>
    <td colspan=3>
    Customer Name: <input name="custname" type=text SIZE=75>
    </td>
    <td>
    Date of Service: <input name="dateofservice" type=text size=15></br>
    </td>
    </tr>
    <tr>
    <td colspan=4>
    Address: <input name="address" type=text size=80></br>
    </td>
    </tr>
    <tr>
    <td>
    City: <input name="city" type=text size=37>
    </td>
    <td><div align=center>
    State <input name="state" type=text size=10 size=15></div>
    </td>
    <td>
    ...
    <tr>
    <td>
    Date of Birth: <input name="dateofbirth" type=text size=15></br>
    </td>
    <td>
    Sex:&nbsp;&nbsp;
    	<input type="radio" name="sex"
		<?php if (isset($dstatusb) && $dstatusb=="Male") echo "checked";?>
		value="Male">Male&nbsp;&nbsp;
		<input type="radio" name="sex"
		<?php if (isset($dstatusb) && $dstatusb=="Female") echo "checked";?>
		value="Female">Female
	</td>
	<td>
    Height: <input name="height" type=text size=15>
    </td>
    <td>
    Weight: <input name="weight" type=text size=15></br>
    </td>
	</tr>
	<tr>
    <td>
    Alternate Contact: <input name="altcontact" type=text size=39>
    </td>
    <td>
    Phone: <input name="phone2" type=text size=20>
    </td>
    <td>
    Relationship <font size=1>(to patient)</font>: <input name="relationship" type=text>
    </td>
    </tr>
    </table>
   <hr class='no-print'>
   ...
   <tr>
   <td>
    Diagnosis: <input name="diagnosis" type=text size=172></br>
    Primary Care Physician: <input name="PCP1" type=text size=70>
    Phone: <input name="PCP1Phone" type=text size=69></br>
    Insurance #1: <input name="ins1" type=text size=83>
    Number: <input name="ins1number" type=text size=67></br>
    Insurance #2: <input name="ins2" type=text size=83>
    Number: <input name="ins2number" type=text size=67>
    </tr>
    </td>
   </table>
   <hr class='no-print'>
   ...
   EQUIPMENT
    ...
    <td colspan=3>
    Lot Number(s): <input name="lotnumbers" type=text size=112></br>
    </td>
    </table>
    <hr class='no-print'>
    ...
    */
    ...
    <td>
    <FONT SIZE=3><b>
    Driver/Office: <input name="driver_office" id="doffice" type=text SIZE=50><font SIZE="2" color=red><b>*REQUIRED</b></font>
    </b>
    </FONT>
    </td>
    </tr>
    <tr>
    <td>
    <div align=center><input type="submit" name="submit" id="submit" value="Save" class="no-print"></div>
    </form>
    </td>
    </td>
    </table>
...
if(isset($_POST['bhosp'])){
	...
	$message = "Please fill out Driver/Office field!";
            ...
            $correctusername= $username."/0"; // enter correct format
				mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO NewCustInfo (`ID`,`Referral`,`PreparedBy`,`Date1`,`Time`, `CustName`, `DateofService`, `Height`,`Weight`,`Address`,`City`,`State`,`Zip`,`Phone`, `Sex`, `DateofBirth`, `AltContact`, `Phone2`, `Relationship`, `Diagnosis`, `Pcp1`, `Pcp1Phone`, `Ins1`, `Ins1Number`, `Ins2`, `Ins2Number`, `eq1`, `eq2`, `eq3`, `eq4`, `eq5`, `eq6`, `eq7`, `eq8`, `eq9`, `eq10`, `eq11`, `eq12`, `eq13`, `eq14`, `eq15`, `eq16`, `eq17`, `eq18`, `eq19`, `eq20`, `eq21`, `eq22`, `eq23`, `eq24`, `eq25`, `eq26`, `eq27`, `eq28`, `eq29`, `eq30`, `eq31`, `eq32`, `eq33`, `eq34`, `eq35`, `eq36`, `eq37`, `eq38`, `eq39`, `eq40`, `eq41`, `eq42`, `eq43`, `eq44`, `eq45`, `eq46`, `eq47`, `eq48`, `eq49`, `eq50`, `eq51`, `eq52`, `eq53`, `eq54`, `eq55`, `eq56`, `eq57`, `eq58`, `eq59`, `eq60`, `eq61`, `eq62`, `eq63`, `eq64`, `eq65`, `eq66`, `eq67`, `eq68`, `eq69`, `eq70`, `eq71`, `eq72`, `eq73`, `eq74`, `eq75`,`eq76`,`eq77`,`eq78`,`eq79`,`eq80`,`eq81`,`LotNumbers`, `CSig1`, `Date2`,`DriverOffice`, `Poster`, `Sent`, `Complete`, `Verified`, `Driver`, `Sender`, `bhosp`)
					Values('','$referral','$preparedby','$date1','$time','$custname','$dateofservice','$height','$weight','$address','$city','$state','$zip','$phone', '$sex', '$dateofbirth', '$altcontact', '$phone2', '$relationship', '$diagnosis', '$pcp1', '$pcp1phone', '$ins1', '$ins1number', '$ins2', '$ins2number','$eq[0]','$eq[1]','$eq[2]','$eq[3]','$eq[4]','$eq[5]','$eq[6]','$eq[7]','$eq[8]','$eq[9]','$eq[10]','$eq[11]','$eq[12]','$eq[13]','$eq[14]','$eq[15]','$eq[16]','$eq[17]','$eq[18]','$eq[19]','$eq[20]','$eq[21]','$eq[22]','$eq[23]','$eq[24]','$eq[25]','$eq[26]','$eq[27]','$eq[28]','$eq[29]','$eq[30]','$eq[31]','$eq[32]','$eq[33]','$eq[34]','$eq[35]','$eq[36]','$eq[37]','$eq[38]','$eq[39]','$eq[40]','$eq[41]','$eq[42]','$eq[43]','$eq[44]','$eq[45]','$eq[46]','$eq[47]','$eq[48]','$eq[49]','$eq[50]','$eq[51]','$eq[52]','$eq[53]','$eq[54]','$eq[55]','$eq[56]','$eq[57]','$eq[58]','$eq[59]','$eq[60]','$eq[61]','$eq[62]','$eq[63]','$eq[64]','$eq[65]','$eq[66]','$eq[67]','$eq[68]','$eq[69]','$eq[70]','$eq[71]','$eq[72]','$eq[73]','$eq[74]','$eq[75]','$eq[76]','$eq[77]','$eq[78]','$eq[79]','$eq[80]','$lotnumbers', '$CSig','$date2','$doffice','$correctusername','0', '0', '0', '', '', '$bhosp')") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
				echo "<div align=center>";
				echo "Data has been logged, thank you.</br>";
				echo "<br><a href='newcustinfo.php'>Next Form</a>";
				echo "</div>";
				header('Location: newcustinfo.php');
	}
	}
?>
