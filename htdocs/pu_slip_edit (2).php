...
?>
    ...
    <html>
    <head>
        <title>Brevard Medical Equipment :: Pickup Slip Edit</title>
    <div align=center>
    ...
    <div align=center> 
<?php
$Query = "SELECT * FROM PickupSlip WHERE `ID`='$get_db_id' ORDER BY ID DESC"; // Sort each entry by DATE, DESCENDING!
...
<?php
	...
	while($information = mysqli_fetch_array($Result))
	{
					...
					$edateofpickup = $information['dateofpickup'];
    ...
    Date of Pickup: <input name="dateofpickup" type=text size=55 value="<?PHP ECHO "$edateofpickup"; ?>"></br>
    Customer Name: <input name="custname" type=text size=100 value="<?PHP ECHO "$ecustname"; ?>"></br>
    Address: <input name="address" type=text size=110 value="<?PHP ECHO "$eaddress"; ?>"></br>
    City: <input name="city" type=text size=49 value="<?PHP ECHO "$ecity"; ?>">
    Phone: <input name="phone" type=text size=49 value="<?PHP ECHO "$ephone"; ?>">
    </td>
    </tr>
    </table>
    <?php
...
<td>
    ...
    */
    ...
    <td><b>
    Driver/Office: <input name="driver_office" id="doffice" type=text size=50 value="<?PHP ECHO "$edoffice"; ?>"><font SIZE="2" color=red><b>*REQUIRED</b></font></br></br></br></br>
    </b>
    </td>
    </tr>
    </table>
    Special Instructions:</br>
	<textarea name="specialinstructions" cols=100 rows=15><?PHP ECHO "$especialinstructions"; ?></textarea></br>
    </br></br>
    
    </font>
    <input type="submit" name="submit" id="submit" value="Update" class="no-print"></br>
	</form>
<?php
...
if(isset($_POST['bhosp'])){
	...
	$message = "Please fill out Driver/Office field!";
				...
				echo "<br><a href='pu_slip_view.php?ID=" . $get_db_id . "'>Slip View</a>";
				echo "</div>";
				header('Location: pu_slip_view.php?ID=' . $get_db_id);
	}
	}
	}
	}
