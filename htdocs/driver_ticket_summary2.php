...
$nickname = $username;
$message = san($_POST['message']);

?>
<b><h3><center>Instant Communication</center></h3></b>
<iframe src="/chatlog/chat_<?php echo $communicate; ?>.txt" width="700" height="250"></iframe>
<form method="post" name="chat">
Message:&nbsp;&nbsp; <input type="text" name="message"><input type="submit" value="Submit">
</form>
<?php
if ($_POST['message']){
    $fp = fopen("/chatlog/chat_" . $communicate . ".txt", "a");
    $stuff = "(" . date("H:i:s") . ") " . $nickname . ": " . $message . "\n";
    fputs($fp, $stuff);
} else {
    echo "Can Not Send Blank Messages!</br>";
}
// ================================ !CHAT CODE ===============================
