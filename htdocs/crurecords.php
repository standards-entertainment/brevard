...
<title>Records :: Cruise Slip</title>
...
<?php
	...
	*/
	...
	$tbl_name = "CruiseSlip";		//your table name
...
<?PHP
	...
	*/
	...
	$targetpage = "crurecords.php"; 	//your file name  (the name of this file)
...
?>
                   ...
                   <table border="2" style="width:100%">
							<tr>
                                ...
                                echo "<a href='" . $ATableGet . "_menu.php?ID=$db_ID'>" . $BTableGet . " Menu</a>";
                                }
								?>
								</div>
                                </td>
