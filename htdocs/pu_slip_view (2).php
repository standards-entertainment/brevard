...
$uvaction = "Unverify";
                ...
                if($_POST['CompleteA']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE PickupSlip SET `Complete`='0', `Completer`='" . $username . "' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
					mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
                ...
                if($_POST['CompleteB']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE PickupSlip SET `Complete`='1', `Completer`='" . $username . "',`CompleteTime`='$completetime' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
					mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
                ...
                if($_POST['VerifyA']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE PickupSlip SET `Verified`='0', `Verifier`='" . $username . "' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
					mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
                ...
                if($_POST['VerifyB']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE PickupSlip SET `Verified`='1', `Verifier`='" . $username . "',`VerifyTime`='$verifytime' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
					mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
