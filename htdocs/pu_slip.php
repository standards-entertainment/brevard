...
?>
   ...
   EQUIPMENT
    ...
    <input name="16a" type=checkbox class="css-checkbox" id="cb16" value="M-6 Tank 165 Liter Refill USP Medical Oxygen"><label for="cb16" class="css-label radGroup1"></label><input name="16b" type=text SIZE=5> M-6 Tank 165 Liter Refill USP Medical Oxygen</br>
	</br></br>
    </td>
    <td>
    ...
    */
    ...
    <td><b>
    Driver/Office: <input name="driver_office" type=text size=50 id="doffice"><font SIZE="2" color=red><b></b></font></br></br>
    </b>
    </td>
    </tr>
    </table>
