...
?>
	...
	<b>Date of Delivery: <font color=red><?php echo $dateofdelivery; ?></font></b></br>
...
$uvaction = "Unverify";
                ...
                if($_POST['CompleteA']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE DeliverySlip SET `Complete`='0', `Completer`='" . $username . "', `Verified`='0', `Verifier`='" . $username . "' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
				mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
                ...
                if($_POST['CompleteB']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE DeliverySlip SET `Complete`='1', `Completer`='" . $username . "',`CompleteTime`='$completetime', `Verified`='1', `Verifier`='" . $username . "',`VerifyTime`='$verifytime' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
				mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
                ...
                if($_POST['VerifyA']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE DeliverySlip SET `Verified`='0', `Verifier`='" . $username . "', `Complete`='0', `Completer`='" . $username . "' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
				mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
                ...
                if($_POST['VerifyB']) {
				mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE DeliverySlip SET `Verified`='1', `Verifier`='" . $username . "',`VerifyTime`='$verifytime', `Complete`='1', `Completer`='" . $username . "',`CompleteTime`='$completetime' WHERE `ID`='" . $db_ID . "'") or die(((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));	
				mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
