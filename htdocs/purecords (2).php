...
<title>Records :: Pick-Up Slip</title>
...
<?php
	...
	*/
	...
	$tbl_name = "PickupSlip";		//your table name
	// How many adjacent pages should be shown on each side?
	$adjacents = 3;
	$DSTableGet = "<a href='dsrecords.php'>Delivery</a>";
	$PUTableGet = "<b><u>Pick Up</b></u>";
...
<?PHP
	...
	*/
	...
	$targetpage = "purecords.php"; 	//your file name  (the name of this file)
