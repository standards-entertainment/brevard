...
<title>Brevard Medical Equipment :: Driver Ticket Summary</title>
...
?>
<div align=center>
<b hidden> You must click <a href='index.php?driver=<?php echo $driverget; ?>'>refresh</a> <i>after</i> clicking update.<br> </b>
    <?php if($user_level > 1) {
...
?>    
<form name="ViewDriver" method="GET" action="index.php">
			<select name="driver">
...
?>
 ...
 <!-- This is where we post the order !-->
        <?php
...
NewCustInfo.eq75, NewCustInfo.eq76, NewCustInfo.eq77, NewCustInfo.eq78, NewCustInfo.eq79, NewCustInfo.eq80, NewCustInfo.eq81, NewCustInfo.Order1, Null as DateofService, 'NewCustInfo' as tbname
...
PickupSlip.eq75, PickupSlip.eq76, PickupSlip.eq77, PickupSlip.eq78, PickupSlip.eq79, PickupSlip.eq80, PickupSlip.eq81, PickupSlip.Order1, PickupSlip.dateofpickup, 'PickupSlip' as tbname 
...
DeliverySlip.eq75, DeliverySlip.eq76, DeliverySlip.eq77, DeliverySlip.eq78, DeliverySlip.eq79, DeliverySlip.eq80, DeliverySlip.eq81, DeliverySlip.Order1, DeliverySlip.DateofDelivery,
'DeliverySlip' as tbname FROM DeliverySlip WHERE DeliverySlip.Driver REGEXP '{$driverget1}/' AND DeliverySlip.Accomplished='0') DUMMY_ALIAS3 ORDER BY Order1
SQL;
...
if($Query != '') {
	...
	while($information = mysqli_fetch_array($Result)) {
					...
					$dateofdelivery = $information['DateofDelivery'];
...
?>
			...
			<table border="2" style="width:100%">
							<tr>
                               ...
                               <?php echo $db_ID; ?>
                                <div align=center><form action='index.php' method='post' name='<?PHP ECHO $db_ID; ?>'>
...
?>
                            ...
                            <tr>
								...
								<td>
								<?php echo "<font color=red>Date of Service: " .  $dateofdelivery . $dateofpickup . $dateofservice . "</font>"; ?>
								</td>
                            </tr>
...
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO AuditTrail (`ID`,`TableName`,`AuditID`,`Username`,`Action`,`Time`)
				...
				echo "Return: <a href='index.php?driver=" . $username1 . "'>Previous Page</a><br>";
...
<center><a href='../chat.php' target='_blank'>Instant Communication</a></center>
<?PHP
