...
// ================================Driver Select Code================================
	if(loggedin()){
?>
View: <?php echo $DSTableGet; ?> | <?php echo $PUTableGet; ?> | <?php echo $NCITableGet; ?> | <?php echo " <a href='driver_ticket_summary.php'>Summary</a> "; ?></br><hr>
<?php
if($user_level > 1) {
...
$Query = "SELECT * FROM `$TableGet` WHERE `Driver` REGEXP '{$driverget}/' AND `Accomplished`='0' ORDER BY ID DESC"; // Sort each entry by DATE, DESCENDING!
} else {
$Query = "SELECT * FROM `$TableGet` WHERE `Driver` REGEXP '{$username}/' AND `Accomplished`='0' ORDER BY ID DESC"; // Sort each entry by DATE, DESCENDING!
//SELECT * FROM `DeliverySlip` WHERE `Driver` REGEXP 'Test123/' AND `Accomplished`='0' ORDER BY ID DESC
}
...
?>
                   <table border="2" style="width:100%">
							<tr>
                                ...
                                <td>
                                    <?php
                                    echo "" . "<font size=2>Special Instructions: </font>" . $specialinstructions . "</font> | ";
